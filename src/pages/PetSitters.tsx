      ...
      <div className="min-h-screen bg-gradient-to-br from-primary/5 to-secondary/5">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
            <TabsList className="-mx-4 grid w-[calc(100%+2rem)] grid-cols-2 grid-rows-2 gap-4 bg-white rounded-2xl p-4 shadow-sm md:grid-cols-4 md:grid-rows-1 md:gap-2 md:mx-0 md:w-full">
              <TabsTrigger 
                value="find" 
