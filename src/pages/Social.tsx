      ...
      <div className="min-h-screen bg-gradient-to-br from-primary/5 to-secondary/5">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
            <TabsList className="-mx-4 w-[calc(100%+2rem)] min-h-[200px] grid grid-cols-1 grid-rows-3 gap-x-4 gap-y-24 bg-white rounded-2xl p-6 shadow-sm md:mx-0 md:w-full md:grid-cols-3 md:grid-rows-1 md:gap-x-2 md:gap-y-0 md:min-h-[96px] md:p-4">{/* Increased mobile spacing by 3x */}
              <TabsTrigger
                value="pet-social"
